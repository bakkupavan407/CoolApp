...
/* harmony import */ var _complaints_complaint_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./complaints/complaint.component */ "./src/app/complaints/complaint.component.ts");
/* harmony import */ var _complaints_complaint_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./complaints/complaint.service */ "./src/app/complaints/complaint.service.ts");
/* harmony import */ var _http_error_handler_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./http-error-handler.service */ "./src/app/http-error-handler.service.ts");
/* harmony import */ var _message_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./message.service */ "./src/app/message.service.ts");
...
/* harmony import */ var _angmaterial__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./angmaterial */ "./src/app/angmaterial.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'complaints', component: _complaints_complaint_component__WEBPACK_IMPORTED_MODULE_7__["ComplaintComponent"] }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _complaints_complaint_component__WEBPACK_IMPORTED_MODULE_7__["ComplaintComponent"],
            ...
            imports: [
                ...
                _angmaterial__WEBPACK_IMPORTED_MODULE_13__["AngMaterialModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot(routes)
            ],
            providers: [
                _complaints_complaint_service__WEBPACK_IMPORTED_MODULE_8__["ComplaintService"],
                _http_error_handler_service__WEBPACK_IMPORTED_MODULE_9__["HttpErrorHandler"],
...
var ComplaintComponent = /** @class */ (function () {
    ...
    ComplaintComponent.prototype.getComplaintById = function (cid) {
...
var ComplaintService = /** @class */ (function () {
    ...
    ComplaintService.prototype.getAllComplaints = function () {
        return this.http.get('api/complaint/GetAllComplaints', httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getAllComplaints', '')));
    };
    ComplaintService.prototype.getComplaintById = function (cid) {
        ...
        return this.http.get('api/complaint/GetComplaintById', httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError('getComplaintById', '')));
    };
